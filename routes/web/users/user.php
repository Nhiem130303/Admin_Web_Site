...
Route::get('dang-nhap', [UserController::class, 'signIn'])->name('sign_in');

Route::get('/', [UserController::class, 'signIn'])->name('sign_in');
...
Route::get('dang-ki', [UserController::class, 'signUp'])->name('sign_up');
